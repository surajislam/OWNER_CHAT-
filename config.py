...
#### ❖ ──────⊱◈◈◈⊰────── ❖
OWNER_ID = int(getenv("OWNER_ID", "6363878696"))
...
#### ❖ ──────⊱◈◈◈⊰────── ❖
SUPPORT_GRP = getenv("SUPPORT_GRP", "secret_world02")

#### ❖ ──────⊱◈◈◈⊰────── ❖
UPDATE_CHNL = getenv("UPDATE_CHNL", "secret_world02")

#### ❖ ──────⊱◈◈◈⊰────── ❖
OWNER_USERNAME = getenv("OWNER_USERNAME", "Shadow_oopss")
